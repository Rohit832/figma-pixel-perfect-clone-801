...
export const SocialLinks: React.FC = () => {
  return (
    <div className="flex w-full flex-col mt-[70px] max-md:mt-10">
      ...
      <div className="text-[rgba(42,98,93,1)] text-sm font-semibold tracking-[0.56px] uppercase mt-[45px] max-md:mt-10">
        Instagram
      </div>
      <div className="text-[rgba(42,98,93,1)] text-sm font-semibold tracking-[0.56px] uppercase mt-[27px]">
        Linkedin
      </div>
      <div className="text-[rgba(42,98,93,1)] text-sm font-semibold tracking-[0.56px] uppercase self-stretch mt-[27px]">
        Mail us on Email
      </div>
    </div>
  );
